...
function App() {
  const [inverted, setState] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "main-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative h-[150vh] bg-gradient-to-b from-sky-900 from-25% via-cyan-700 via-40% to-yellow-200 bg-no-repeat before:bg-gradient-to-r before:from-green-400 before:to-blue-500 ${inverted ? "invert" : "invert-0"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky self-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "flex items-center backdrop-blur-sm bg-black/30 shadow-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "ml-[2rem] my-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "font-inter font-bold bg-black/30 hover:bg-white/20 inline-block rounded-md py-2 px-4 text-zinc-300", href: "#", children: "Home" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "ml-[2rem] my-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "font-inter font-bold hover:bg-white/20 inline-block rounded-md py-2 px-4 text-zinc-300", href: "#", children: "About" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "ml-[2rem] my-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "font-inter font-bold hover:bg-white/20 inline-block rounded-md py-2 px-4 text-zinc-300", href: "#", children: "Resources" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "ml-[2rem] my-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "font-inter font-bold hover:bg-white/20 inline-block rounded-md py-2 px-4 text-zinc-300", href: "#", children: "these buttons dont do anything" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "ml-[2rem] my-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "font-inter font-bold hover:bg-white/20 inline-block rounded-md py-2 px-4 text-zinc-300", href: "#", children: "don't say anything tho" }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col mx-auto my-[15vh] items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "max-w-prose text-4xl sm:text-5xl md:text-6xl lg:text-8xl align-middle font-inter font-bold text-zinc-200 drop-shadow-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Why I should get" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "max-w-prose py-4 text-4xl sm:text-5xl md:text-6xl lg:text-8xl my-5 align-middle font-inter font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-yellow-200 drop-shadow-2xl", children: "full points for this project" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "max-w-prose text-xl sm:text-2xl md:text-3xl lg:text-4xl align-middle font-inter font-bold text-zinc-200 drop-shadow-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "and not fail this class" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex mx-5 rounded-md bg-black/30 backdrop-blur-md border-black/50 h-[60vh] drop-shadow-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mx-20 my-20 ", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mx-20 my-20 text-4xl text-white font-bold", children: "1. I think this website looks good, so I should get points for that" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mx-20 my-20 text-4xl text-white font-bold", children: "2. It has at least three files!!! An HTML, CSS, and JavaScript" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mx-20 my-20 text-4xl text-white font-bold", children: "3. It's super interactive!! Check out this button which inverts the website colors!!!!" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setState(!inverted), className: "my-10 mx-20 font-inter font-bold bg-black/30 hover:bg-white/20 inline-block rounded-md py-10 px-40 text-zinc-300", children: "Invert the colors" }) })
      ] }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: `h-[100vh] bg-gradient-to-b from-yellow-200 via-rose-300 to-violet-400 ${inverted ? "invert" : "invert-0"}` }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: `h-[100vh] bg-gradient-to-b from-violet-400 via-indigo-800 to-black ${inverted ? "invert" : "invert-0"}` })
  ] });
}
const index = "";
